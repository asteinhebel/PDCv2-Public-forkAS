...
class dsumPlotter:
    ...
    def initAxs(self):
        ...
        for iPdc in range(self.nPdcMax):
            ...
            self.axs[iPdc].set_ylabel("Counts")
            self.axs[iPdc].set_xlabel("Time [s]") if DEFAULT_TIMEX else self.axs[iPdc].set_xlabel("FIFO Bin")
    ...
    def updateAllData(self):
        ...
        for iPdc in range(self.nPdcMax):
            ...
            if self.compareXdata(iPdc=iPdc):
                ...
                setXlim = True
                self.axs[iPdc].set_xlabel("Time [s]") if dp.timex else self.axs[iPdc].set_xlabel("FIFO Bin")
